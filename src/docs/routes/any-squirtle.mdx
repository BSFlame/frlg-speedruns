...
- Use the IV constraints on the left if you are a beginner, otherwise use the constraints on the right:
  ...
  ![BeginnerIV](../../../static/img/frlg/BeginnerIV.png)
  ![AdvancedIV](../../../static/img/frlg/AdvancedIV.png)

  Additionally, only allow **Modest**, **Mild** and **Rash** natures.

- Avoid 28 Sp. Atk unless really good stats.
- The first 6 steps on normal grass, 7 steps in Viridian Forest, and 8 Steps in Mt. Moon are a 1% chance to get an encounter.
  This rule restarts after every brand new encounter.
...
- ### Rival 1
  ...
  - <Pokemon name="Bulbasaur" />: <StateContext>
      {({ starter: { nature, atk } }) =>
        (nature === 'modest' || atk <= 3) && (
          <>
            <PokeMove name="Tail Whip" /> x1,{' '}
          </>
        )
      }
    </StateContext>
...
- ### Bug Catcher Sammy
  ...
  - <Pokemon name="Weedle" />: <PokeMove name="Tail Whip" /> x1-2, <PokeMove name="Tackle" /> x4-6
    ...
    - <MoveDamage
      ...
      />
    - <PoisonDamage name="squirtle" level={6} ev={0} displayLevel={true} />
    - <PoisonDamage name="squirtle" level={7} ev={0} displayLevel={true} />
...
- Attempt to get torrent in as little turns as possible on this route.
  ...
  - If no torrent for level 14, get it off the 2nd level 10 <Pokemon name="Caterpie" />.
    - <LevelUpStatGain
        name="squirtle"
        level={13}
        stat="hp"
        ev={{ before: 2, after: 2 }}
      />
  - If no torrent for level 15, get it off the level 11 <Pokemon name="Caterpie" />.
    - <LevelUpStatGain
        name="squirtle"
        level={14}
        stat="hp"
...
- ### Super Nerd Miguel
  ...
  - <Pokemon name="Grimer" />: <PokeMove name="Water Gun" /> x2
    ...
    - If you can survive two turns of Poison and a <PokeMove name="Tackle"/>
      then use <PokeItem name="Antidote" /> on <Pokemon name="Voltorb" />.
    - Swap <PokeMove name="Tackle"/> and <PokeMove name="Water Gun"/> on T2 of <Pokemon name="Grimer" />.
    - <PoisonDamage
        name="wartortle"
        level={16}
        ev={6}
  ...
  - <Pokemon name="Voltorb" />: <PokeMove
    ...
    - <MoveDamage
        name="Tackle"
        player={{ name: 'wartortle', level: 17, ev: 12 }}
        enemy={{ name: 'voltorb', level: 12, atk: 12 }}
        adjustEV={adjustEV('afterMtMoon')}
      />
...
- After the fight:
  - Teach <PokeMove name="Water Pulse" /> over <PokeMove name="Tackle" /> (Slot 1 if swapped).
...
- ### Rival
  ...
  - <Pokemon name="Pidgeotto" />: <PokeMove name="Bite" /> ,<PokeMove name="Water Pulse" />

    - 25% (4/16) to OHKO with <PokeMove name="Water Pulse" /> Torrent
    - <PokeMove name="Bite" /> + <PokeMove name="Water Pulse" /> is a 94.9% range without Torrent.
    - <MoveDamage
        name="Quick Attack"
...
- Grab this hidden <PokeItem name="Ether" /> (risky but can skip if Torrent at 26 and 2x <PokeMove name="Mega Kick" /> left).
...
- ### Rival
  ...
  - <Pokemon name="Raticate" />: <PokeMove
    ...
    - <MoveDamage
        name="Quick Attack"
        player={{ name: 'wartortle', level: 26, ev: 19 }}
        enemy={{ name: 'raticate', level: 16, atk: 34 }}
        displayLevel={true}
        adjustEV={adjustEV('afterNob')}
      />
    - <MoveDamage
...
- ### Leader Surge
  - Swap <PokeMove name="Water Pulse" /> and <PokeMove name="Water Gun" />
...
## Cerulean City
- Swap <PokeItem name="TM Case" /> above the Bike.
...
- ### Jr Trainer Sofia
 - <Pokemon name="Jigglypuff" />: <PokeMove
      name="Water Gun"
      torrent={true}
    /> / <PokeMove name="Water Pulse" />
 - <Pokemon name="Pidgey" />: <PokeMove
      name="Water Gun"
      torrent={true}
    /> / <PokeMove name="Water Pulse" />
 - <Pokemon name="Meowth" />: <PokeMove
      name="Water Gun"
      torrent={true}
    /> / <PokeMove name="Water Pulse" />
...
- Grab this <PokeItem name="Rare Candy" /> after fighting Lift Key Grunt or before spinny tiles if going to level 35 now.
...
- ### Rocket Grunt
  ...
  - <Pokemon name="Sandshrew" />: <PokeMove name="Bite" />
  - <PokeMove name="Bite" /> is a 14/16 if left grunt first.
  - <Pokemon name="Sandslash" />: <PokeMove name="Water Gun" />
  - <Pokemon name="Ekans" />: <PokeMove name="Water Gun" torrent={true} /> / <PokeMove name="Water Pulse" />
...
- ### Rocket Grunt
  ...
  - <Pokemon name="Ekans" />: <PokeMove name="Water Pulse" />
  - <Pokemon name="Sandshrew" />: <PokeMove name="Water Gun" />
  - <PokeMove name="Bite" /> is a 9/16 if right grunt first.
  - <Pokemon name="Arbok" />: <PokeMove name="Water Pulse" torrent={true} /> / <PokeMove name="Bite" />, <PokeMove name="Water Pulse" />
    ...
    - <LevelUpStatGain
        ...
        level={36}
        stat="hp"
        ev={{ before: 15, after: 15 }}
        adjustEV={adjustEV('afterEric')}
      />

  - <PokeItem name="Rare Candy" /> to level 36.
...
- ### Leader Koga
  ...
  - <Pokemon name="Muk" />: <PokeMove name="Surf" torrent={true} />, (<PokeItem
    ...
    - <MoveDamage
        name="Sludge"
        player={{ name: 'blastoise', level: 39, ev: 39 }}
  ...
  - <Pokemon name="Weezing" />: <PokeMove name="Surf" torrent={true} /> (at +1)
    ...
    - <StateContext>
        {({ starter }) => starter.spa >= 30 && '6/16 to OHKO'}
      </StateContext>

    - <MoveDamage
        name="Sludge"
        player={{ name: 'blastoise', level: 40, ev: 39 }}
...
- ### Leader Blaine
  ...
  - <StateContext>
    ...
    - <MoveDamage
        name="Take Down"
        player={{ name: 'blastoise', level: 40, ev: 42, defBadge: true }}
        enemy={{ name: 'growlithe', level: 42, atk: 63 }}
      />
    - <MoveDamage
        name="Fire Blast"
        player={{ name: 'blastoise', level: 40, ev: 8 }}
        enemy={{ name: 'growlithe', level: 42, atk: 63 }}
      />
  ...
  - <Pokemon name="Rapidash" />: <PokeMove name="Surf" />
    ...
    - <MoveDamage
        name="Bounce"
        player={{ name: 'blastoise', level: 41, ev: 42, defBadge: true }}
        enemy={{ name: 'rapidash', level: 42, atk: 80 }}
      />
    - <MoveDamage
        name="Fire Blast"
        player={{ name: 'blastoise', level: 41, ev: 8 }}
...
- Use <PokeItem name="Rare Candy"/> to level 44 here.
...
- ### Rival
  ...
  - <Pokemon name="Pidgeot" />: <PokeItem
    ...
    - Use 2x <PokeItem name="X Sp Atk" text="X Special" /> if going for Gyarados range.
    - <MoveDamage
        name="Wing Attack"
  ...
  - <Pokemon name="Gyarados" />: <PokeMove name="Blizzard" />, <PokeMove name="Bite" />
    ...
    - 68.75% (11/16) to OHKO at +2 at level 44, not a range at level 45.
...
- Use <PokeItem name="Full Restore" /> and <PokeItem name="Super Repel" /> , put cursor on X Accs before fighting the rival.
- ### Rival
...
- Before talking to first boulder:
